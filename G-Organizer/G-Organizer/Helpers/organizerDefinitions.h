...
#define OPTIONAL_HEADER_TITLE @"Optional fields"

#define AVATAR_CELL_HEIGHT   150.0
#define STANDART_CELL_HEIGHT 44.0
#define TAKE_PHOTO_FROM_CAMERA @"Take avatar from camera"
#define TAKE_PHOTO_FROM_ALBUM @"Take avatar from album"
#define LOGIN_FIELD_IS_EMPTY @"Login field is empty, please fill it for successful registration."
